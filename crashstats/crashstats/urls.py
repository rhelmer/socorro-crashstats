...
urlpatterns = patterns('',
    ...
    url(r'^products/(?P<product>\w+)/versions/(?P<versions>[;\w\.()]+)/?$',
        views.products,
        name='crashstats.products'),
    url(r'^products/(?P<product>\w+)/topcrasher/byversion$',
        views.topcrasher,
        name='crashstats.topcrasher'),
    url(r'^products/(?P<product>\w+)/versions/(?P<versions>[;\w\.()]+)/topcrasher/byversion$',
        views.topcrasher,
        name='crashstats.topcrasher'),
    url(r'^products/(?P<product>\w+)/versions/(?P<versions>[;\w\.()]+)/(?P<days>\d+)/topcrasher/byversion$',
        views.topcrasher,
        name='crashstats.topcrasher'),
    url(r'^products/(?P<product>\w+)/versions/(?P<versions>[;\w\.()]+)/(?P<days>\d+)/(?P<crash_type>\w+)/topcrasher/byversion$',
        views.topcrasher,
        name='crashstats.topcrasher'),
    url(r'^products/(?P<product>\w+)/versions/(?P<versions>[;\w\.()]+)/(?P<days>\d+)/(?P<crash_type>\w+)/(?P<os_name>[\w\s]+)/topcrasher/byos$',
        views.topcrasher,
        name='crashstats.topcrasher'),
    url(r'^products/(?P<product>\w+)/daily$',
        views.daily,
        name='crashstats.daily'),
    url(r'^products/(?P<product>\w+)/(?P<versions>[;\w\.()]+)/daily$',
        views.daily,
        name='crashstats.daily'),
    ...
    url(r'^products/(?P<product>\w+)/versions/(?P<versions>[\w\.()]+)/builds.rss$',
        views.BuildsRss(),
        name='crashstats.buildsrss'),
    url(r'^products/(?P<product>\w+)/hangreport$',
        views.hangreport,
        name='crashstats.hangreport'),
    url(r'^products/(?P<product>\w+)/versions/(?P<versions>[;\w\.()]+)/hangreport$',
        views.hangreport,
        name='crashstats.hangreport'),
    ...
    url(r'^products/(?P<product>\w+)/versions/(?P<versions>[\w\.()]+)/topchangers$',
        views.topchangers,
        name='crashstats.topchangers'),
    url(r'^products/(?P<product>\w+)/versions/(?P<versions>[\w\.()]+)/(?P<days>\d+)/topchangers$',
        views.topchangers,
        name='crashstats.topchangers'),
