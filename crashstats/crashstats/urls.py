...
urlpatterns = patterns('',
    ...
    url(products + versions + '/$',
        views.products,
        name='crashstats.products'),
    url(products + '/report/topcrasher$',
        views.topcrasher,
        name='crashstats.topcrasher'),
    url(products + versions + '/report/topcrasher$',
        views.topcrasher,
        name='crashstats.topcrasher'),
    url(products + versions + days + '/report/topcrasher$',
        views.topcrasher,
        name='crashstats.topcrasher'),
    url(products + versions + days + crash_type + '/report/topcrasher$',
        views.topcrasher,
        name='crashstats.topcrasher'),
    url(products + versions + days + crash_type + os_name
                 + '/report/topcrasher$',
        views.topcrasher,
        name='crashstats.topcrasher'),
    url(products + '/report/daily$',
        views.daily,
        name='crashstats.daily'),
    url(products + versions + '/report/daily$',
        views.daily,
        name='crashstats.daily'),
    url(products + '/report/builds$',
        views.builds,
        name='crashstats.builds'),
    # note the deliberate omission of the ';' despite calling the regex variable 'versionS'
    url(products + '/versions/(?P<versions>[\w\.()]+)' + '/report/builds$',
        views.builds,
        name='crashstats.builds'),
    url(products + '/report/builds.rss$',
        views.BuildsRss(),
        name='crashstats.buildsrss'),
    url(products + versions + '/report/builds.rss$',
        views.BuildsRss(),
        name='crashstats.buildsrss'),
    url(products + '/report/hangs$',
        views.hangs,
        name='crashstats.hangs'),
    url(products + versions + '/report/hangs$',
        views.hangs,
        name='crashstats.hangs'),
    url(products + versions + days + '/report/hangs$',
        views.hangs,
        name='crashstats.hangs'),
    url(products + '/report/topchangers$',
        views.topchangers,
        name='crashstats.topchangers'),
    url(products + versions + '/report/topchangers$',
        views.topchangers,
        name='crashstats.topchangers'),
    url(products + versions + days + '/report/topchangers$',
        views.topchangers,
        name='crashstats.topchangers'),
    url(r'^report/list$',
        views.report_list,
