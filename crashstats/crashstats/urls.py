...
urlpatterns = patterns('',
    ...
    url(r'^hangreport/byversion/(?P<product>\w+)/(?P<version>[\w\.()]+)$', views.hangreport,
    ...
    url(r'^topcrasher/plot_signature/(?P<product>\w+)/(?P<version>[\w\.()]+)/(?P<start_date>[0-9]{4}-[0-9]{2}-[0-9]{2})/(?P<end_date>[0-9]{4}-[0-9]{2}-[0-9]{2})/(?P<signature>.*)',
