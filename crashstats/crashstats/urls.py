...
urlpatterns = patterns('',
    ...
    url(r'^products/(?P<product>\w+)/(?P<versions>[;\w\.()]+)/topcrasher/byversion$',
        views.topcrasher,
        name='crashstats.topcrasher'),
    url(r'^products/(?P<product>\w+)/(?P<versions>[;\w\.()]+)/(?P<days>\d+)/topcrasher/byversion$',
        views.topcrasher,
        name='crashstats.topcrasher'),
    url(r'^products/(?P<product>\w+)/(?P<versions>[;\w\.()]+)/(?P<days>\d+)/(?P<crash_type>\w+)/topcrasher/byversion$',
        views.topcrasher,
        name='crashstats.topcrasher'),
    url(r'^products/(?P<product>\w+)/(?P<versions>[;\w\.()]+)/(?P<days>\d+)/(?P<crash_type>\w+)/(?P<os_name>[\w\s]+)/topcrasher/byos$',
        views.topcrasher,
        name='crashstats.topcrasher'),
