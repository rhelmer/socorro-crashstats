...
urlpatterns = patterns('',
    ...
    url(products + versions + '/$',
        views.products,
        name='crashstats.products'),
    url(products + '/topcrasher$',
        views.topcrasher,
        name='crashstats.topcrasher'),
    url(products + versions + '/topcrasher$',
        views.topcrasher,
        name='crashstats.topcrasher'),
    url(products + versions + days + '/topcrasher$',
        views.topcrasher,
        name='crashstats.topcrasher'),
    url(products + versions + days + crash_type + '/topcrasher$',
        views.topcrasher,
        name='crashstats.topcrasher'),
    url(products + versions + days + crash_type + os_name + '/topcrasher$',
        views.topcrasher,
        name='crashstats.topcrasher'),
    url(products + '/daily$',
        views.daily,
